...
const userMiddlewares = require('../infrastructure/middlewares/userMiddlewares')
...
module.exports = createController(userController)
  .prefix('/api/user')
  .post('/', 'create', {
    before: userMiddlewares.validateCreateUser
  })
  .get('/', 'retrieveAll', {
    before: roleMiddleware.validateRoleAdmin
  })
  .get('/:id', 'retrieve')
  .patch('/:id', 'update')
  .delete('/:id', 'delete')
